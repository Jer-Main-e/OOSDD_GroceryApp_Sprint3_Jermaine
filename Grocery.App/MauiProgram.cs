...
namespace Grocery.App
{
    public static class MauiProgram
    {
        public static MauiApp CreateMauiApp()
        {
            ...
            builder.Services.AddSingleton<IUserOVService, UserOVService>();
            ...
            builder.Services.AddSingleton<IUserOVRepository, UserOVRepository>();
            ...
            builder.Services.AddTransient<UserOVView>().AddTransient<UserOVViewModel>();
